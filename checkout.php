...
<head>
    ...
    <title>Checkout || Creative Multipurpose Bootstrap4 Template</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcaump-inner text-center">
                            <h2 class="heading heading-h2">รายการสินค้า</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="checkout_area pt--80 pb--150">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <!-- Checkout Form s-->
                            <form action="checkoutaction.php" class="checkout-form" method="POST">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 mb--20">
                                        ...
                                        <div id="billing-form" class="mb--40">
                                            <h4 class="checkout-title">ที่อยู่สำหรับจัดส่งสินค้า</h4>

                                            <div class="row">

                                                <div class="col-md-6 col-12 mb--20">
                                                    <label>ชื่อ*</label>
                                                    <input type="text" name="first_name" placeholder="กรุณาระบุ ชื่อ">
                                                </div>

                                                <div class="col-md-6 col-12 mb--20">
                                                    <label>นามสกุล*</label>
                                                    <input type="text" name="last_name" placeholder="กรุณาระบุ นามสกุล">
                                                </div>

                                                <div class="col-md-6 col-12 mb--20">
                                                    <label>อีเมล*</label>
                                                    <input type="email" name="email" placeholder="กรุณาระบุ อีเมล">
                                                </div>

                                                <div class="col-md-6 col-12 mb--20">
                                                    <label>เบอร์โทรศัพท์*</label>
                                                    <input type="text" name="tel" placeholder="กรุณาระบุ เบอร์โทรศัพท์">
                                                </div>
                                                ...
                                                <div class="col-12 mb--20">
                                                    <label>ที่อยู่*</label>
                                                    <input type="text" name="address1" placeholder="รายละเอียดที่อยู่">
                                                    <input type="text" name="address2" placeholder="รายละเอียดที่อยู่ เพิ่มเติม">
                                                </div>
                                                ...
                                                <div class="col-md-6 col-12 mb--20">
                                                    <label>อำเภอ*</label>
                                                    <input type="text" name="city" placeholder="กรุณาระบุ อำเภอ">
                                                </div>

                                                <div class="col-md-6 col-12 mb--20">
                                                    <label>ตำบล*</label>
                                                    <input type="text" name="state" placeholder="กรุณาระบุ ตำบล">
                                                </div>

                                                <div class="col-md-6 col-12 mb--20">
                                                    <label>รหัสไปรษณีย์*</label>
                                                    <input type="text" name="zip_code" placeholder="กรุณาระบุ รหัสไปรษณีย์">
                                                </div>
                                    ...
                                    <div class="col-lg-5">
                                        <div class="row">
                                            ...
                                            <div class="col-12 mb--60">
                                                ...
                                                <h4 class="checkout-title">รายการสินค้า</h4>

                                                <div class="checkout-cart-total">

                                                    <h4>สินค้า <span>จำนวน</span></h4>

                                                    <ul>
                                                        <li>ยางลบ<span>20.00 ฿</span></li>
                                                        <li>ดินสอ<span>10.00 ฿</span></li>
                                                        <li>ปากกา<span>25.00 ฿</span></li>
                                                        <li>ไม้บรรทัด<span>25.00 ฿</span></li>
                                                    </ul>

                                                    <p>รวม <span>80.00 ฿</span></p>
                                                    <p>ค่าจัดส่ง <span>20.00 ฿</span></p>

                                                    <h4>รวมทั้งสิ้น <span>100.00 ฿</span></h4>
                                            ...
                                            <div class="col-12 mb--60">
                                                ...
                                                <h4 class="checkout-title">วิธีการชำระเงิน</h4>
                                                ...
                                                <div class="checkout-payment-method">
                                                    ...
                                                    <div class="single-method">
                                                        <input type="radio" id="payment_check" name="payment-method"
                                                            value="bank_transfer">
                                                        <label for="payment_check">โอนเข้าบัญชี ธนาคาร</label>
                                                        <p data-method="check">กรุณาโอนเงินเข้า บัญชีธนาคาร พร้อมแนบสลิปการชำระเงิน</p>
                                                    </div>

                                                    <div class="single-method">
                                                        <input type="radio" id="payment_bank" name="payment-method"
                                                            value="bank">
                                                        <label for="payment_bank">True Money Wallet</label>
                                                        <p data-method="True Money">โอนเงินบัญชี True Money Wallet พร้อมแนบสลิปการชำระเงิน</p>
                                                    </div>

                                 
                                                </div>
                                                <div class="plceholder-button mt--50">
                                                    <button type="submit" name="action" value="buy" class="brook-btn bk-btn-theme btn-sd-size btn-rounded space-between">สั่งซื้อสินค้า</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
